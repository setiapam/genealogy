<footer class="text-center print:hidden text-neutral-600 dark:text-neutral-200 lg:text-left">
    <div class="flex items-center justify-center p-2 border-b-2 border-neutral-200 dark:border-neutral-500 lg:justify-between bg-neutral-200 dark:bg-neutral-700">
        ...
        <div class="flex justify-center">
            ...
            <a href="https://x.com/dimasetia_budi/" class="mr-6 text-neutral-600 dark:text-neutral-200" target="_blank" title="X">
                <x-ts-icon icon="brand-x" class="text-neutral-900 dark:text-neutral-200" />
            </a>

            <a href="https://www.instagram.com/dimasetiapam/" class="mr-6 text-neutral-600 dark:text-neutral-200" target="_blank" title="Instagram">
                <x-ts-icon icon="brand-instagram" class="text-neutral-900 dark:text-neutral-200" />
            </a>

            <a href="https://www.linkedin.com/in/setiapam/" class="mr-6 text-neutral-600 dark:text-neutral-200" target="_blank" title="LinkedIn">
            ...
            <a href="https://github.com/setiapam" class="text-neutral-600 dark:text-neutral-200" target="_blank" title="GitHub">
